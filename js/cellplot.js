...
CellPlot=function(container){
	...
	if(this.canvas.error){
		...
		htmlerror.innerHTML="Sorry, WebGLRender init fault. Seems your brower didn't support webgl. <br> Try to access <a href=\"http://get.webgl.org/\">http://get.webgl.org </a> to have a test of the WebGl's support. <br> In another way you need to use <a href=\"http://windows.microsoft.com/en-us/internet-explorer/download-ie\">IE11</a> or <a href=\"http://www.mozilla.org/en-US/firefox/new/\" >FireFox </a>instead.<br> Here have some useful information blow . <br>When you are use chrome, go to chrome:\/\/gpu to see if webgl is support. If so try to restart chrome or reload the page see whether the page works. Try to check info in chrome:\/\/flags .<br> When you are using Chromium in linux and webgl can't work anyway, <a href=\"http://askubuntu.com/questions/299345/how-to-enable-webgl-in-chrome-on-ubuntu\">Here </a> may help you.<br>When you are using safari, maybe you need to open webgl manually.<a href=\"http://onvert.com/guides/enable-webgl-safari/\">Here </a> have some method to enable<br> Anyway email me at i@catofes.com to get more infomation.";
